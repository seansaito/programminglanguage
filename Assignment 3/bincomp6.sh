...
ocamlc -pp "cppo -I ../ -D TRACE" -annot VarGen.cmo str.cma debug.cmo  sPL.cma sPLc.cma sPL_token.cma sPL_lexer.cmo sPL_parser.cmo sPL_type.cma sPL_type_m.ml -o splt
